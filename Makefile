...
CFLAGS = $(INCLUDE_PATHS) $(DEFINES) $(DIAGNOSTIC_FLAGS) $(COMPILER_WARNING_FLAGS) $(COMPILER_SANITIZERS) $(DEFAULT_COMPILER_OPTIMIZATION_LEVEL) $(COMPILER_STANDARD)
CFLAGS_FAST = $(INCLUDE_PATHS) $(DIAGNOSTIC_FLAGS) $(COMPILER_WARNING_FLAGS) $(COMPILER_OPTIMIZATION_LEVEL_SPEED) $(COMPILER_STANDARD)
CFLAGS_SMALL = $(COMPILER_WARNING_FLAGS) $(DIAGNOSTIC_FLAGS) $(COMPILER_OPTIMIZATION_LEVEL_SPACE) $(COMPILER_STANDARD)
LDFLAGS = 
