...
CFLAGS = $(INCLUDE_PATHS) $(COMMON_DEFINES) $(DIAGNOSTIC_FLAGS) $(COMPILER_STANDARD)
...
$(info CFLAGS for TST)
CFLAGS += -DTEST $(COMPILER_SANITIZERS) $(COMPILER_WARNINGS_TEST_BUILD) $(COMPILER_STATIC_ANALYZER) $(COMPILER_OPTIMIZATION_LEVEL_DEBUG)
...
$(info CFLAGS for DBG)
CFLAGS += $(COMPILER_SANITIZERS) $(COMPILER_WARNING_FLAGS) $(COMPILER_STATIC_ANALYZER) $(COMPILER_OPTIMIZATION_LEVEL_DEBUG)
endif
